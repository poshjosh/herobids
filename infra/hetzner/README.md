...
- `AUTH_PUBLIC_BASE_URL` and `AUTH_FRONTEND_ORIGIN` are currently hardcoded in the compose overlay. These will be parameterized in a future phase. For custom domains, edit the compose file directly.
