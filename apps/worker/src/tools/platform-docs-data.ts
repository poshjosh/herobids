...
For privacy-related questions, contact us at **[support@openaidom.com](mailto:support@openaidom.com)**.`,
    headings: ['Data we collect', 'Account data', 'Trading data', 'Usage data', 'How we use your data', 'Data storage', 'Third-party services', 'Google API Services User Data Policy', 'Your rights', 'Contact'],
