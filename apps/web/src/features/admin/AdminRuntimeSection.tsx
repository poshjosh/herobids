    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <Card style={{ padding: 0 }}>
        <div style={{ padding: '14px 20px', borderBottom: '1px solid var(--color-border-subtle)', display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <span style={{ padding: '2px 8px', borderRadius: '20px', fontSize: '0.6875rem', fontWeight: '600', background: 'var(--color-surface-3)', color: 'var(--color-text-muted)' }}>
              ...
              <tbody>
                {containers.map((c) => (
                  <tr key={c.Id} style={{ borderBottom: '1px solid var(--color-border-subtle)' }}>
                    ...
                    <Td>
                      <span style={{ fontSize: '0.75rem', color: 'var(--color-text-muted)' }}>{c.Status}</span>
                    </Td>
                    <Td>
                      {c.SizeRw != null
                        ? <span style={{ fontSize: '0.75rem', color: 'var(--color-text-muted)' }}>{fmtBytes(c.SizeRw)}</span>
