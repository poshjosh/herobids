export const messages: Record<string, string> = {
  ...
  'agents.authorizationMode.direct': 'Direct — executes accepted trade decisions immediately',
  'agents.authorizationMode.approvalRequired': 'Approval required — sends each trade decision to you for approval first',
  ...
  'agents.authorizationMode.approvalRequiredHelp': 'Each trade proposal is sent to you for approval before any market action. Approve or reject from the web app or Telegram using /yes <code> and /no <code>.',
