export const messages: Record<string, string> = {
  ...
  'agents.create.loadingBindings': 'प्लेटफ़ॉर्म लिंक लोड हो रहे हैं…',
  'agents.create.noBindings': 'अभी तक कोई सक्रिय प्लेटफ़ॉर्म लिंक नहीं। अभी ट्रेडिंग सेटअप करें या AI एजेंट बनाकर बाद में लिंक करें।',
