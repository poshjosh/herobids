export const messages: Record<string, string> = {
  ...
  'agents.controls.openPositionEscalationPolicy.never': 'स्काउट को पहले ओपन पोजीशन का निरीक्षण करने दें',
  'agents.controls.openPositionEscalationPolicy.uncovered_or_triggered': 'केवल तभी एस्केलेट करें जब कवरेज गायब हो या कोई वॉच फायर करे',
  'agents.controls.openPositionEscalationPolicy.always': 'हमेशा ओपन पोजीशन को जज के पास एस्केलेट करें',
