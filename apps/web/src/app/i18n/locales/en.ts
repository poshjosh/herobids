export const messages: Record<string, string> = {
  ...
  'settings.telegram.description':
    'Bind your Telegram account to receive AI agent messages and safety alerts directly in Telegram. Start a chat with the OpenAIdom bot and send /start — the bot will reply with your chat ID. Paste it here.',
