export const messages: Record<string, string> = {
  ...
  'agents.authorizationMode.directHelp': 'Executes accepted trade decisions immediately with no human review.',
  'agents.authorizationMode.approvalRequiredHelp': 'Sends each trade proposal to you for approval before any market action.',
