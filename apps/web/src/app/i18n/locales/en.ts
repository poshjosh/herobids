export const messages: Record<string, string> = {
  ...
  'activity.subtitle': 'What your agents have been doing',
  'activity.noActivity.title': 'No activity yet',
  'activity.noActivity.message':
    'Events will appear here as your agents make decisions, place orders, and manage positions.',
  ...
  'activity.instance.started': 'Agent started',
  'activity.instance.stopped': 'Agent stopped',
  'activity.instance.crashed': 'Agent crashed: {reason}',
  ...
  'missionControl.subtitle':
    '{activeCount, plural, one {# active agent} other {# active agents}} across {totalCount} total',
  'missionControl.createAgent': 'Create agent',
  'missionControl.noAgents.title': 'No agents yet',
  'missionControl.noAgents.message':
    'Create an agent from a goal, then attach capabilities only when you need them.',
  ...
  'missionControl.section.agents': 'Your agents',
  ...
  'outcomes.subtitle': 'How each agent is progressing',
  'outcomes.noAgents.title': 'No agents yet',
  'outcomes.noAgents.message':
    'Create an agent to start tracking published outputs, user-facing summaries, and recent progress.',
  'outcomes.metric.total': 'Total agents',
  ...
  'settings.telegram.description':
    'Bind your Telegram account to receive agent messages and safety alerts directly in Telegram. Start a chat with the Herobids bot, send /start, then paste your chat ID here.',
  ...
  'aiModels.premium.help': 'Used when the agent needs stronger reasoning.',
  ...
  'credentials.modal.providerPlaceholder': 'e.g. hyperliquid, telegram, zapier',
  ...
  // Agents
  'agents.title': 'Agents',
  'agents.subtitle': 'Goal-driven agents with explicit skills and execution modes',
  ...
  'agents.summary.openAgent': 'Open agent',
  ...
  'agents.create.goal': 'What should the agent do?',
  'agents.create.goalPlaceholder': 'e.g. Grow my Solana portfolio conservatively over 30 days',
  'agents.create.skills': 'Skills',
  'agents.create.skillsHelp': 'Base is included automatically. Select any additional skills the agent should have after creation.',
  ...
  'agents.create.models.title': 'Model selection',
  'agents.create.models.description': 'These values start from your saved settings and can be overridden for this agent.',
  ...
  'agents.review.title': 'Review and create',
  'agents.review.models': 'Model selection',
  ...
  'agents.edit.skillsHelp': 'Base is included automatically. Select the skills this agent should keep using.',
  ...
  'agents.edit.models.title': 'Model overrides',
  'agents.edit.models.description': 'This agent uses explicit provider and model overrides.',
  'agents.edit.models.inherited': 'This agent inherits your saved model settings: {provider} / {lightModel} / {heavyModel}',
  ...
  'agents.controls.tickInterval': 'Tick interval (ms)',
  'agents.controls.tickInterval.placeholder': 'e.g. 900000 for 15 min',
  ...
  'agents.detail.runtimeAlert.crashed': 'Agent crashed. The runtime stopped unexpectedly. Review recent activity and capability readiness below.',
  'agents.detail.runtimeAlert.unhealthy': 'Agent runtime is unhealthy. Heartbeats are missing and the worker is recovering.',
  ...
  'agents.detail.deleteConfirm': 'Delete this agent? This cannot be undone. Any running session will be stopped.',
  'agents.detail.deleting': 'Deleting…',
  'agents.detail.agentStatus': 'Agent status',
  ...
  'agents.detail.promptUnavailable': 'System prompt is available only while a recent runtime snapshot exists.',
  'agents.detail.capabilities': 'Capabilities',
  'agents.detail.bindingReadiness': 'Binding readiness',
  'agents.detail.agentEligibility': 'Agent eligibility',
  ...
  'agents.detail.messageAuthor.agent': 'Agent',
  ...
  'agents.capabilityPage.subtitle': 'Agent: {agent}',
  ...
  'outcomes.noSummary': 'No agent-authored summary yet.',
