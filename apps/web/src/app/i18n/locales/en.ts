export const messages: Record<string, string> = {
  ...
  'agents.create.emailDelivery.help': 'Controls whether this agent may email you when it explicitly requests delivery. Emails go to your account address.',
  ...
  'agents.edit.models.reasoning.scoutLabel': 'Scout reasoning',
  'agents.edit.models.reasoning.judgeLabel': 'Judge reasoning',
  'agents.edit.models.reasoning.scoutHelp': 'Controls how much the scout model thinks before each check-in. Overrides your saved AI model settings.',
  'agents.edit.models.reasoning.judgeHelp': 'Controls how much the judge model thinks before trading decisions. Overrides your saved AI model settings.',
