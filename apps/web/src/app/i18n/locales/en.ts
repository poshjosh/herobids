export const messages: Record<string, string> = {
  ...
  'agents.create.loadingBindings': 'Loading platform links…',
  'agents.create.noBindings': 'No active platform links yet. Set up trading now or create the AI agent and link it later.',
