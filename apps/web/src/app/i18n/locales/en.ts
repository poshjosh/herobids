export const messages: Record<string, string> = {
  ...
  'agents.capabilityPage.noBindings': 'No platform links yet. Complete trading setup from Mission Control or when creating an agent, then return here to link.',
  ...
  'agents.style.careful.description': 'Minimal cost, conservative risk. Light models, shallow tool loops, tight context budgets. US trading hours only.',
  'agents.style.balanced.label': 'Balanced',
  'agents.style.balanced.description': 'Standard cost, moderate risk. Mix of light and heavy models, standard tool depth and context.',
  'agents.style.bold.label': 'Bold',
  'agents.style.bold.description': 'Premium cost, aggressive risk. Heavy models, deep tool loops, generous context. 24/7 trading.',
  'agents.style.summaryPrefix': 'This style gives you:',

  // Agent runtime policy (advanced)
  'agents.runtimePolicy.title': 'Runtime Policy',
  'agents.runtimePolicy.description': 'Fine-tune tool depth, context budgets, and trading hours. Leave fields empty to use style defaults.',
  ...
  'agents.runtimePolicy.lightThinkingTokens': 'Light thinking tokens',
  'agents.runtimePolicy.deepThinkingTokens': 'Deep thinking tokens',
  'agents.runtimePolicy.allowedHoursUtc': 'Allowed trading hours (UTC)',
  'agents.runtimePolicy.allowedHoursUtcHelp': 'Comma-separated hours 0–23. Empty = always allowed.',
  ...
  'agents.runtimePolicy.maxHoldDurationMs': 'Max hold duration (ms)',
};
