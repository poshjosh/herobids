export const messages: Record<string, string> = {
  ...
  'auth.sendLoginLink.mobile': 'Send link',
  ...
  'auth.signInWithPassword.mobile': 'Use password',
  'auth.signIn': 'Sign in',
  ...
  'settings.telegram.description':
    'Bind your Telegram account to receive AI agent messages and safety alerts directly in Telegram. Start a chat with the @OpenAIdomBot and send /start — the bot will reply with your chat ID. Paste it here.',
  ...
  'agents.summary.connections': 'Connections',
  'agents.summary.loadingConnections': 'Loading connections…',
  'agents.summary.none': 'none',
  ...
  'agents.create.switchToForm': 'Use the form',
  'agents.create.switchToGuided': 'Use guided chat',
  'agents.create.refresh': 'Refresh',
  'agents.create.name': 'Name',
  'agents.create.namePlaceholder': 'e.g. market-watch-01',
  'agents.create.goal': 'Objective / prompt',
  'agents.create.goal.subtitle': '(What should the AI agent do?)',
  'agents.create.goalBoth': 'Objective / prompt',
  'agents.create.goalBoth.subtitle': '(Instructions / Goal)',
  'agents.create.goalPlaceholder': 'e.g. Grow this portfolio aggressively',
  'agents.create.goalPlaceholder.trading': 'e.g. Grow this portfolio',
  'agents.create.goalPlaceholder.personalAssistant': 'e.g. Remind me next week Tuesday to wish Jane a happy birthday',
  'agents.create.goalPlaceholder.custom': 'e.g. Analyse the attached document for grammatical errors',
  ...
  'agents.edit.dailyMaxLossPct': 'Daily loss limit (%)',
  ...
  'agents.controls.dailyMaxLossPct': 'Daily loss limit (%)',
  'agents.controls.dailyMaxLossPct.help': 'Hard cap on rolling 24h realized loss as a percentage of equity. Leave blank to use the platform default.',
  ...
  'conflict': 'Cannot complete this action due to a conflict with the current state.',
  'config_invalid': 'Bot config is invalid — cannot start. Fix the config before retrying.',
  'no_ai_provider': 'No AI provider is configured on this platform.',
  ...
  'invalid_target': 'The target resource is not valid for this operation.',
  'forbidden': 'You do not have permission to perform this action.',
  'connection.missing_venue_account': 'No venue account found for this connection. Please complete trading setup first.',
  'max_bots_reached': 'Agent has reached its maximum concurrent bots limit. Stop a bot before starting a new one.',
  'no_session_found': 'No completed session found for this scope.',
  'scope_resolution_failed': 'Evaluation scope could not be resolved.',
  'narrative_llm_resolution_failed': 'Narrative AI configuration could not be resolved.',
  ...
  // Landing page
  'landing.tagline': 'Affordable AI agents that get the job done',
  'landing.description': 'We offer AI as a service so that you can have your own personal assistant without needing to know about agents, servers or hosting.',
  'landing.signIn': 'Sign in',
  'landing.tryIt': 'Try it',
  'landing.proof.cost.heading': 'Our agents cost less',
  'landing.proof.cost.text': 'We focus our research on saving cost. We believe we are No.\u00a01 on affordability, without losing effectiveness; and we are increasing the gap.',
  'landing.proof.cost.link': 'See how costs are kept low',
  'landing.proof.oneClick.heading': 'Get your agent in one click',
  'landing.proof.oneClick.text': 'After login. Click one button to create your AI agent, the same way you sign one letter to employ a new team member. Thereafter onboard your new AI employee.',
  'landing.proof.oneClick.link': 'Employ your first AI agent',
  'landing.letter.toggle': 'A letter for you',
  'landing.letter.greeting': 'Dear OpenAIdom user,',
  'landing.letter.intro': 'This is what we offer:',
  'landing.letter.para1': 'Imagine you create your own AI personal assistant, then send it a message on Telegram:',
  'landing.letter.quote1': 'I am on a tight budget, so I want you to help me save money by spending wisely',
  'landing.letter.para1b': 'Your assistant is an AI agent, and knows that its reasoning and actions cost money, so it adjusts.',
  'landing.letter.para2': 'Next you tell your assistant to:',
  'landing.letter.quote2': 'find the best flight deal from Bengaluru to San Francisco between 1st and 3rd of next month.',
  'landing.letter.para2b': 'Your assistant asks a few questions to clarify your preferences, and then it goes to work. Not long after you receive an email from your assistant with a link to the best flight deal.',
