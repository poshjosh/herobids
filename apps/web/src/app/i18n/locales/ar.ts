export const messages: Record<string, string> = {
  ...
  'agents.create.name.autoGeneratedHint': 'تم إنشاؤه تلقائياً من اختيار النمط. عدّله لتخصيصه.',  'agents.create.skillPreset': 'قالب المهارات',
  ...
  'agents.create.models.description': 'تبدأ هذه القيم من إعداداتك المحفوظة ويمكن تجاوزها لوكيل الذكاء الاصطناعي هذا.',
  ...
  'agents.create.capabilitySetupMessage': 'اختر ربط تداول موجود لإرفاق وصول التداول أثناء إنشاء وكيل الذكاء الاصطناعي.',
  'agents.create.tradingBinding': 'ربط التداول',
  'agents.create.loadingBindings': 'جارٍ تحميل روابط التداول…',
  'agents.create.noBindings': 'لا توجد روابط تداول نشطة بعد. أعدّ التداول الآن أو أنشئ وكيل الذكاء الاصطناعي واربطه لاحقاً.',
  ...
  'agents.review.capabilitySetup.bound': 'سيتم ربط التداول المحدد عند الإنشاء',
  ...
  'agents.controls.dailySpendBudget': 'ميزانية الإنفاق اليومية للذكاء الاصطناعي (USD)',
