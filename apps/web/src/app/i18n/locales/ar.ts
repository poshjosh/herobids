export const messages: Record<string, string> = {
  ...
  'activity.subtitle': 'ما يقوم به وكلاؤك',
  'activity.noActivity.title': 'لا نشاط حتى الآن',
  'activity.noActivity.message':
    'ستظهر الأحداث هنا عندما يتخذ وكلاؤك قرارات ويضعون أوامر ويديرون المراكز.',
  ...
  'activity.instance.started': 'بدأ الوكيل',
  'activity.instance.stopped': 'توقف الوكيل',
  'activity.instance.crashed': 'تعطّل الوكيل: {reason}',
  ...
  'missionControl.subtitle':
    '{activeCount, plural, =0 {لا وكلاء نشطون} one {وكيل نشط واحد} two {وكيلان نشطان} few {# وكلاء نشطون} many {# وكيلاً نشطاً} other {# وكيل}} من أصل {totalCount}',
  'missionControl.createAgent': 'إنشاء وكيل',
  'missionControl.noAgents.title': 'لا يوجد وكلاء بعد',
  'missionControl.noAgents.message':
    'أنشئ وكيلاً من هدف، ثم ألحق القدرات فقط عند الحاجة.',
  ...
  'missionControl.section.agents': 'وكلاؤك',
  ...
  'outcomes.subtitle': 'كيف يتقدم كل وكيل',
  'outcomes.noAgents.title': 'لا يوجد وكلاء بعد',
  'outcomes.noAgents.message':
    'أنشئ وكيلاً لتبدأ في تتبع المخرجات المنشورة والملخصات والتقدم الأخير.',
  'outcomes.metric.total': 'إجمالي الوكلاء',
  ...
  'settings.telegram.description':
    'اربط حسابك على تيليغرام لتلقي رسائل الوكيل وتنبيهات السلامة مباشرةً في تيليغرام. ابدأ محادثة مع بوت Herobids، وأرسل /start، ثم الصق معرّف المحادثة هنا.',
  ...
  'credentials.modal.providerPlaceholder': 'مثلاً hyperliquid أو telegram أو zapier',
  ...
  'agents.subtitle': 'وكلاء موجهون بالأهداف مع مهارات وأوضاع تنفيذ واضحة',
  'agents.newAgent': 'وكيل جديد',
  'agents.createAgent': 'إنشاء وكيل',
  'agents.empty.title': 'لا يوجد وكلاء بعد',
  ...
  'agents.summary.openAgent': 'فتح الوكيل',
  ...
  'agents.create.title': 'إنشاء وكيل',
  'agents.create.goal': 'ما الذي يجب أن يفعله الوكيل؟',
  'agents.create.goalPlaceholder': 'مثلاً نمِّ محفظتي على سولانا بشكل محافظ خلال 30 يوماً',
  'agents.create.skills': 'المهارات',
  'agents.create.skillsHelp': 'يتم تضمين المهارة الأساسية تلقائياً. اختر أي مهارات إضافية يحتاجها الوكيل بعد الإنشاء.',
  ...
  'agents.create.models.title': 'اختيار النموذج',
  'agents.create.models.description': 'تبدأ هذه القيم من إعداداتك المحفوظة ويمكن تجاوزها لهذا الوكيل.',
  ...
  'agents.review.title': 'مراجعة وإنشاء',
  'agents.review.models': 'اختيار النموذج',
  ...
  'agents.edit.title': 'تعديل الوكيل',
  'agents.edit.name': 'الاسم',
  'agents.edit.objective': 'الهدف / الموجّه',
  'agents.edit.skillsHelp': 'يتم تضمين الأساس تلقائياً. اختر المهارات التي يجب أن يستمر الوكيل في استخدامها.',
  ...
  'agents.edit.models.title': 'تجاوزات النموذج',
  'agents.edit.models.description': 'يستخدم هذا الوكيل مزوّداً ونماذج محددة صراحةً.',
  'agents.edit.models.inherited': 'يرث هذا الوكيل إعدادات النموذج المحفوظة لديك: {provider} / {lightModel} / {heavyModel}',
  ...
  'agents.detail.notFound': 'لم يتم العثور على الوكيل',
  'agents.detail.runtimeAlert.crashed': 'تعطل الوكيل. توقّف التشغيل بشكل غير متوقع. راجع النشاط الأخير وجاهزية القدرات أدناه.',
  'agents.detail.runtimeAlert.unhealthy': 'تشغيل الوكيل غير سليم. نبضات القلب مفقودة والعامل يتعافى.',
  ...
  'agents.detail.deleteConfirm': 'حذف هذا الوكيل؟ لا يمكن التراجع عن ذلك. سيتم إيقاف أي جلسة جارية.',
  'agents.detail.deleting': 'جارٍ الحذف…',
  'agents.detail.agentStatus': 'حالة الوكيل',
  ...
  'agents.detail.agentEligibility': 'أهلية الوكيل',
  ...
  'agents.detail.messageAuthor.agent': 'الوكيل',
  ...
  'agents.capabilityPage.subtitle': 'الوكيل: {agent}',
  ...
  'outcomes.noSummary': 'لا يوجد ملخص من الوكيل بعد.',
