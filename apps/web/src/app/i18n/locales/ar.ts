export const messages: Record<string, string> = {
  ...
  'agents.create.goalPlaceholder': 'مثلاً نمِّ محفظتي على سولانا بشكل محافظ خلال 30 يوماً',
  'agents.create.skillPreset': 'قالب المهارات',
  ...
  'agents.detail.promptUnavailable': 'الموجّه النظامي متاح فقط عند وجود لقطة تشغيل حديثة.',
