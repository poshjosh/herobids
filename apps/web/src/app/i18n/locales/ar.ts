export const messages: Record<string, string> = {
  ...
  'agents.create.emailDelivery.help': 'يتحكم في ما إذا كان هذا الوكيل يمكنه إرسال بريد إلكتروني إليك عند طلبه صراحةً. تُرسَل الرسائل إلى عنوان بريدك الإلكتروني المسجَّل.',
  ...
  'agents.edit.models.reasoning.scoutLabel': 'استدلال المستكشف',
  'agents.edit.models.reasoning.judgeLabel': 'استدلال الحكم',
  'agents.edit.models.reasoning.scoutHelp': 'يتحكم في مقدار تفكير نموذج المستكشف قبل كل فحص. يتجاوز إعدادات نموذج الذكاء الاصطناعي المحفوظة.',
  'agents.edit.models.reasoning.judgeHelp': 'يتحكم في مقدار تفكير نموذج الحكم قبل قرارات التداول. يتجاوز إعدادات نموذج الذكاء الاصطناعي المحفوظة.',
