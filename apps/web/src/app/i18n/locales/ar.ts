export const messages: Record<string, string> = {
  ...
  'agents.create.skillsHelp': 'يتم تضمين المهارة الأساسية تلقائياً. اختر أي مهارات إضافية يحتاجها وكيل الذكاء الاصطناعي بعد الإنشاء.',
  ...
  'agents.skillPicker.empty': 'يتم تضمين الأساس تلقائياً. لا توجد مهارات إضافية متاحة بعد.',
  'agents.edit.title': 'تعديل وكيل الذكاء الاصطناعي',
  'agents.edit.name': 'الاسم',
  'agents.edit.objective': 'الهدف / الموجّه',
  'agents.edit.skillsHelp': 'يتم تضمين الأساس تلقائياً. اختر المهارات التي يجب أن يستمر وكيل الذكاء الاصطناعي في استخدامها.',
  'agents.edit.skillsHelpPreserved': 'سيتم الاحتفاظ بالمهارات المخفية الحالية ما لم تستبدلها.',
  ...
  'credential.provider_mismatch': 'مزود بيانات الاعتماد {credentialVenue} لا يطابق {provider}.',
  ...
  'agents.runtimePolicy.maxHoldDurationMs': 'الحد الأقصى لمدة الاحتفاظ (مللي ثانية)',
