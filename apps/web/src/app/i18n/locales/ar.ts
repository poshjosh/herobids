export const messages: Record<string, string> = {
  ...
  'agents.risk.conservative.label': 'محافظ',
  'agents.risk.conservative.description': 'مراكز أصغر وقدرة أقل على السحب',
  'agents.risk.moderate.label': 'متوسط',
  'agents.risk.moderate.description': 'توازن بين المخاطرة والعائد',
  'agents.risk.aggressive.label': 'عدواني',
  ...
  'agents.create.technicalPreFilter.label': 'فلتر تقني مسبق',
