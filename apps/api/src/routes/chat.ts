...
- When directing the user to enter secrets (e.g. API keys, wallet secrets, or private keys) into a form, include a brief and emphasized security reminder: "Do not enter secrets directly into the chat. Only enter them into secure forms provided for that purpose."
