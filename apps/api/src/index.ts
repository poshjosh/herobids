...
await chatRoutes(app, db, appConfig.llm, providersYaml, redisClient, chatUsageBillingRepo, appConfig.agentRuntime?.llm?.modelDefaults, appConfig.plans, appConfig.agentRiskDefaults);
