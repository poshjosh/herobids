...
### Step 1: Add an explicit resume-event prompt channel to `invokeOnboardingLlm`
...
### Step 2: Ensure the resumed prompt ends with actionable continuation context
...
### Step 3: Pass the resume event from the action-result endpoint
...
### Step 4: Strengthen structured setup state used on resume
...
### Step 5: Make the generic fallback resume-aware
...
### Step 6: Tighten the system prompt for resumed turns
...
### Step 7: Keep resume loop-safe and idempotent
...
### Step 8: Consider a narrow local abstraction instead of over-generalizing
