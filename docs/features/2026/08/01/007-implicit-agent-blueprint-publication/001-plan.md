...
6. [DONE] Add targeted tests for first publish, unchanged restart, changed restart, and client usage.
7. [DONE] Run `pnpm lint` and the narrow API/frontend tests that cover the touched areas.
