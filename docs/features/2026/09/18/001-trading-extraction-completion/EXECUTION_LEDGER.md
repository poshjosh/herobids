...
| C2.3 | blocked | ADR 011; exact mirror manifest and mandatory dual-checkout CI design | herobids=`416dd58add0b4b4841b27275da58d3200db7e81f`; traderton=`d60c56e56514b3ed0d262871d6febc75e18cc0b3` | Local validation only (no remote workflow run claimed): committed Herobids `416dd58add0b4b4841b27275da58d3200db7e81f` against committed Traderton `d60c56e56514b3ed0d262871d6febc75e18cc0b3`, and committed Traderton `d60c56e56514b3ed0d262871d6febc75e18cc0b3` against committed Herobids `416dd58add0b4b4841b27275da58d3200db7e81f`. | Blocked pending publication of both commits: GitHub Actions cannot fetch local-only SHAs. After publication, run both remote slow workflows and record the results. Protected pairs: Herobids source `${{ github.sha }}` with Traderton `d60c56e56514b3ed0d262871d6febc75e18cc0b3`; Traderton source `${{ github.sha }}` with Herobids `416dd58add0b4b4841b27275da58d3200db7e81f`. Assertion-only; no runtime authority. |
...
- **C2.3:** Publish Herobids `416dd58add0b4b4841b27275da58d3200db7e81f` and Traderton `d60c56e56514b3ed0d262871d6febc75e18cc0b3`, then run and record both remote slow workflows. The workflow pins are now updated to this consistent pair, but the immutable SHAs must still be published before GitHub Actions can fetch them (they remain local-only).
