...
| C2.3 | blocked | ADR 011; exact mirror manifest and mandatory dual-checkout CI design | herobids=`01bbb35046f6a391e7c59143ab42f9a0df450242` (committed baseline; final pin/checker/test update uncommitted); traderton=`485c31c16180d30cf77fe330bf84e4a1c26b06da` | 2026-09-19, Node 22 container: Herobids current worktree at HEAD `01bbb35046f6a391e7c59143ab42f9a0df450242` versus clean Traderton `485c31c16180d30cf77fe330bf84e4a1c26b06da` passed 4/4 checker tests and the protected-mode manifest comparison. Traderton `485c31c16180d30cf77fe330bf84e4a1c26b06da` versus a temporary Herobids `01bbb35046f6a391e7c59143ab42f9a0df450242` worktree with only the uncommitted checker/test expansion overlaid also passed 4/4 and the protected-mode comparison. | Blocked pending publication of both commits and the final Herobids update: GitHub Actions cannot fetch local-only SHAs. After publication, rerun both remote slow workflows; then record the final Herobids commit and mark verified. Intended protected pairs: Herobids source `${{ github.sha }}` with Traderton `485c31c16180d30cf77fe330bf84e4a1c26b06da`; Traderton source `${{ github.sha }}` at `485c31c16180d30cf77fe330bf84e4a1c26b06da` with Herobids `01bbb35046f6a391e7c59143ab42f9a0df450242`. Assertion-only; no runtime authority. |
| C2.1/C2.2 | planned | C1 verified; C2.3 verified | — | — | Boundary defaults before local enforcement removal |
| C3a | in progress | ADR 014; C3 UAT rows updated before run | uncommitted (commit intentionally not created) | 2026-09-19: `CapabilityPresentation` focused UI test passed (2/2); `pnpm --filter @herobids/web run typecheck` and `pnpm lint` passed. Static sweep found no P&L formatter in generic agent components. | Authorized 2026-09-19. Starting SHAs: herobids=01bbb350, traderton=485c31c. Visual-only phase complete in code; desktop/mobile fixture UAT remains blocked by unavailable browser automation and authenticated fixture. |
