...
- **Status:** **REVIEW-CORRECTED; PENDING IMPLEMENTATION AUTHORIZATION** — B1 is ratified as ADR 010. Implementation begins only after C1a is verified and the execution ledger records both repository SHAs; the Traderton half and the Herobids companion may be one coordinated run when performed in the stated order.
