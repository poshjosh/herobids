...
- [x] **(DONE)** Implement Bybit tickers provider
- [x] **(DONE)** Extend `priceService` with Bybit execution-price resolution
- [x] **(DONE)** Extract venue-aware orderbook scanner candidate discovery
