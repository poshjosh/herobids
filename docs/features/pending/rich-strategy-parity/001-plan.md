...
1. Phase 0 — sub-schema extraction (prerequisite for Phase 2; pure refactor, no risk)
2. Phase 1 — sentiment port (tiny, unblocks Phase 4)
3. Phase 2 — `MechanicalParamsSchema` (needs Phase 0 names)
4. Phase 3 — `CandleFetcher` port + wiring (needed by Phase 4)
5. Phase 4 — `MechanicalStrategy` (needs 0, 1, 2, 3)
6. Phase 5 — `HybridStrategy` (needs 4)
7. Phase 6 — factory + composition root wiring (needs 4, 5)
8. Phase 7 — UI (separate spec, depends on agent UI plan being complete first)
