...
### Step 1: Extend venue ports (`packages/domain`)
...
### Step 2: Implement in venue adapters (`packages/venues`)
...
### Step 3: Create instrument cache (`apps/worker/src/`)
...
### Step 4: Add validation to decision intake
...
### Step 5: Wire up in worker (`apps/worker/src/index.ts`)
...
### Step 6: Populate instruments table (optional, Phase 2)
